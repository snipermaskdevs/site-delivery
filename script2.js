// Botão editar e excluir adicionado
...
function updateCart() {
    ...
    cart.forEach((item, index) => {
        ...
        editButton.classList.add('edit');  // Adiciona a classe de estilo para editar
        editButton.onclick = () => editItem(index);

        const deleteButton = document.createElement('button');
        deleteButton.textContent = 'Excluir';
        deleteButton.classList.add('delete');  // Adiciona a classe de estilo para excluir
...
function removeItem(index) {
    ...
    totalPrice -= item.price * item.quantity;  // Subtrai o total do item removido
